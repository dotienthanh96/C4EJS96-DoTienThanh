    ...
    for ( let a of jobData.hits[0].benefits ) {console.log("-" +  a.benefitValue)}

    // 2.7
    for ( let a of jobData.hits )  {for (let b of a.benefits) {console.log(b.benefitValue)}}
    //2.8
    
    for ( let a of jobData.hits) { 
        console.log(a.jobTitle);
        console.log(`${a.jobSalary}$`);
        {console.log(a.locations[0])};
       for ( let b of a.benefits) {console.log(b.benefitValue)};
        for ( let c of a.skills) {console.log(c)};
    }
