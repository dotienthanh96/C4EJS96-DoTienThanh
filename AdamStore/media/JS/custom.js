...
itemNew.innerHTML = '';
    ...
    itemTrend.innerHTML = '';
    soProductTrend(product[2].pic, product[2].name, product[2].des, product[2].price);
    soProductTrend(product[3].pic, product[3].name, product[3].des, product[3].price);
    soProductTrend(product[4].pic, product[4].name, product[4].des, product[4].price);
    ...
    soProductCaretory(product[1].pic, product[1].name, product[1].des, product[1].price);
    soProductCaretory(product[3].pic, product[3].name, product[3].des, product[3].price);
